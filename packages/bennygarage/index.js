let impound = mp.colshapes.newSphere(-192.95, -1293.30, 31.2866, 1, 0);
...
mp.events.add("server:bennygarage:openMenu",(player) => {
    gm.mysql.handle.query("SELECT v.model,v.id,v.numberPlate, c.firstname, c.lastname FROM vehicles v LEFT JOIN characters c ON c.id = v.charId WHERE v.impounded = '7'",[],function(err,res) {
