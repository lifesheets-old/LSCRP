...
ui_Main.AddItem(neon = new UIMenuItem("Neon Licht", "Neon ein/ausbauen"));
...
ui_Neon.AddItem(new UIMenuItem("Auswählen", ""));
ui_Neon.AddItem(new UIMenuItem("Rot", ""));
ui_Neon.AddItem(new UIMenuItem("Pink", ""));
ui_Neon.AddItem(new UIMenuItem("Lila", ""));
ui_Neon.AddItem(new UIMenuItem("Blau", ""));
ui_Neon.AddItem(new UIMenuItem("Hellblau", ""));
ui_Neon.AddItem(new UIMenuItem("Grün", ""));
ui_Neon.AddItem(new UIMenuItem("Gelb", ""));
ui_Neon.AddItem(new UIMenuItem("Orange", ""));
ui_Neon.AddItem(new UIMenuItem("Weiß", ""));
// VISIBILITY NEON
