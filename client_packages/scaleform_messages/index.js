...
mp.game.ui.messages = {
    showShard: (title, message, titleColor, bgColor, time = 20000) => mp.events.call("ShowShardMessage", title, message, titleColor, bgColor, time),
    ...
    showKick: (title, message) => mp.events.call("ShowKickMessage", title, message),
